...
public class ATLFile2Model {
	...
	public void injectATLTrafo(EMFModel atlModel2) throws FileNotFoundException, ATLCoreException {
		IModel parseToModel;
		
		AtlParser parser=new AtlParser();
		InputStream stream = new FileInputStream(atlFile);
		 parseToModel = parser.parseToModel(stream);
