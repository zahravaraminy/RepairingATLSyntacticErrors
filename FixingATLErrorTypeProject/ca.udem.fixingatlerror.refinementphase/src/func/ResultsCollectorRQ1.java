...
public class ResultsCollectorRQ1 {
	...
	public static String MTname = "PNML2PN";//PNML2PN CD2RD UML2BPMN
	...
	public static	String dataFolderName ="output/"+MTname+"/";
	static	String sourceFolderName = "output/"+MTname+"/Mutants";
